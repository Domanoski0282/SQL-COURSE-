...
;
# show potnetial profit on most freq bought items so nussiness can pan to restock fav items
SELECT * 
FROM products
;
...
#shows shipping status on ordered itmes that have not been fulfilled yet 
